...
const CLAUSES_OPTION_2 = [
  'CLÁUSULA PRIMEIRA - OBJETO DO CONTRATO\nO LOCADOR aluga ao LOCATÁRIO o imóvel residencial situado à {ADDRESS}, composto por {DESCRIPTION}.',
  'CLÁUSULA SEGUNDA - DA DESTINAÇÃO DO IMÓVEL\n2.1 O LOCATÁRIO declara que o imóvel, ora locado, destina-se única e exclusivamente para o seu uso RESIDENCIAL.\n2.2 O LOCATÁRIO obriga por si e demais dependentes a cumprir e a fazer cumprir integralmente as disposições legais sobre o Condomínio, a sua Convenção e o seu Regulamento Interno.',
  'CLÁUSULA TERCEIRA - DO PRAZO DE VIGÊNCIA\n3.1 O prazo da locação é de um ano, iniciando-se em {START_DATE} com término em {END_DATE}, com prorrogação automática após o término das especificações citadas acima.\n3.2 Findo o prazo ajustado, se o locatário continuar na posse do imóvel alugado por mais de trinta dias sem oposição do locador, presume - se - á prorrogada a locação por prazo indeterminado, mantidas as demais cláusulas e condições do contrato.',
  'CLÁUSULA QUARTA - DA FORMA DE PAGAMENTO\n4.1 O aluguel mensal deverá ser pago até o dia 10 (dez) do mês subsequente ao vencido, por meio de BOLETO BANCÁRIO informado no campo abaixo , no valor de {MONTHLY_VALUE} , reajustados anualmente, pelo {ADJUSTMENT_INDEX} , reajustamento este sempre incidente e calculado sobre o último aluguel pago no último mês do ano anterior.\n4.2 O aluguel mensal será de {MONTHLY_VALUE}, pagável até o dia 10 de cada mês, mediante BOLETO BANCÁRIO a ser emitido pelo LOCADOR.\n4.3 O comprovante de pagamento deverá ser enviado ao LOCADOR imediatamente após a realização do pagamento, através de whatsapp (64) 999696680 ou outro meio acordado entre as partes.',
  'CLÁUSULA QUINTA - DA MULTA E JUROS DE MORA\n5.1 Em caso de mora no pagamento do aluguel, o valor será corrigido pelo {ADJUSTMENT_INDEX} até o dia do efetivo pagamento e acrescido da multa moratória de {LATE_FEE}% e dos juros de 1% (um por cento) ao dia de atraso.',
  'CLÁUSULA SEXTA - GARANTIA LOCATÍCIA (CAUÇÃO OU SEGURO FIANÇA)\n6.1 Para garantia do fiel cumprimento das obrigações assumidas neste contrato, o LOCATÁRIO optará por uma das seguintes modalidades de garantia locatícia:\nI – DEPÓSITO CAUÇÃO:\nO LOCATÁRIO entregará ao LOCADOR, neste ato, a quantia de {GUARANTEE_VALUE}, a título de caução, a ser depositado em conta vinculada conforme previsto na Lei nº 8.245/91.\nParágrafo Primeiro: O valor da caução será devolvido ao LOCATÁRIO ao final da locação, desde que não haja débitos pendentes relativos a aluguéis, encargos, danos ao imóvel ou quaisquer outras obrigações contratuais.\nParágrafo Segundo: Caso existam débitos ou danos, o LOCADOR poderá utilizar total ou parcialmente o valor da caução para sua quitação, devendo eventual saldo remanescente ser devolvido ao LOCATÁRIO.\nII – SEGURO FIANÇA LOCATÍCIA:\nAlternativamente, o LOCATÁRIO poderá optar pela contratação de seguro fiança locatícia junto à seguradora Porto Seguro, comprometendo-se a apresentar a apólice vigente no ato da assinatura deste contrato.\nParágrafo Primeiro: O seguro deverá permanecer válido durante todo o período da locação, sendo de inteira responsabilidade do LOCATÁRIO sua renovação anual ou conforme exigido pela seguradora.\nParágrafo Segundo: A apólice deverá cobrir, no mínimo, os valores referentes a aluguéis, encargos locatícios, multas contratuais e eventuais danos ao imóvel.\nParágrafo Terceiro: A não renovação ou cancelamento do seguro implicará em infração contratual, podendo o LOCADOR exigir a substituição imediata da garantia ou considerar rescindido o contrato, conforme legislação vigente.',
  'CLÁUSULA SÉTIMA - DO CONSUMO E COBRANÇA DE ENERGIA ELÉTRICA\nO LOCATÁRIO ficará responsável pelo pagamento do consumo de energia elétrica do imóvel locado, sendo adotado o valor de R$ 0,90 (noventa centavos) por quilowatt-hora (kWh) consumido.\n\nPara apuração do consumo, será realizada a leitura do medidor de energia no dia 01 (um) de cada mês subsequente, considerando-se a diferença entre a leitura atual e a leitura do mês anterior.\n\nO valor correspondente ao consumo de energia elétrica será calculado com base na quantidade de kWh efetivamente consumida no período e será cobrado juntamente com o valor mensal do aluguel.\n\nA cobrança será discriminada no boleto bancário, contendo de forma separada e identificada o valor referente ao aluguel e o valor referente ao consumo de energia elétrica, podendo ser anexada cópia da fatura ou demonstrativo de consumo para conferência do LOCATÁRIO.',
  'CLÁUSULA OITAVA - DA CONSERVAÇÃO, REFORMAS E BENFEITORIAS NECESSÁRIAS\n8.1. Ao LOCATÁRIO recai a responsabilidade por zelar pela conservação, limpeza e segurança do imóvel.\n8.2 As benfeitorias necessárias introduzidas pelo LOCATÁRIO, ainda que não autorizadas pelo LOCADOR, bem como as úteis, desde que autorizadas, serão indenizáveis e permitem o exercício do direito de retenção. As benfeitorias voluptuárias não serão indenizáveis, podendo ser levantadas pelo LOCATÁRIO, finda a locação, desde que sua retirada não afete a estrutura e a substância do imóvel.\n8.3 O LOCATÁRIO está obrigado a devolver o imóvel em perfeitas condições de limpeza, conservação e pintura, quando finda ou rescindida esta avença, conforme constante no termo de vistoria em anexo.\n8.4 O LOCATÁRIO não poderá realizar obras que alterem ou modifiquem a estrutura do imóvel locado, sem prévia autorização por escrito. No caso de prévia autorização, as obras serão incorporadas ao imóvel, sem que caiba ao LOCATÁRIO qualquer indenização pelas obras ou retenção por benfeitorias.\n8.5 Cabe ao LOCATÁRIO verificar a voltagem e a capacidade de instalação elétrica existente no imóvel, sendo de sua exclusiva responsabilidade pelos danos e prejuízos que venham a ser causados em seus equipamentos elétrico-eletrônico por inadequação à voltagem e/ou capacidade instalada. Qualquer alteração da voltagem deverá de imediato ser comunicada ao LOCADOR, por escrito. Ao final da locação, antes de fazer a entrega das chaves, o LOCATÁRIO deverá proceder a mudança para a voltagem original.\n8.6 O LOCADOR deve responder pelos vícios ou defeitos anteriores à locação.\n8.7 O LOCATÁRIO(a) se compromete a manter o imóvel em boas condições de conservação and limpeza durante todo o período de locação.\n8.8 O LOCATÁRIO será cobrado um valor fixo de {PAINT_COST} para cobrir os custos de pintura, valor este que será pago ao LOCADOR no momento da entrega das chaves.\n8.9 O LOCATÁRIO(a) também é responsável por realizar todos os reparos necessários para devolver o imóvel nas mesmas condições em que o recebeu, salvo deteriorações decorrentes do uso normal.\n8.10 Em caso de não cumprimento das obrigações de reparo, o LOCADOR(a) poderá executar os serviços necessários e cobrar do LOCATÁRIO(a) os custos correspondentes, os quais deverão ser quitados em até 10 (dez) dias após a notificação.\nPARÁGRAFO ÚNICO: O LOCATÁRIO declara receber o imóvel em perfeito estado de conservação e perfeito funcionamento devendo observar o que consta no termo de vistoria, não respondendo por vícios ocultos ou anteriores à locação.',
  'CLÁUSULA NONA - DAS TAXAS E TRIBUTOS\n9.1 A partir da data da entrega das chaves, o LOCATÁRIO(a) se responsabiliza pela transferência e pagamento das contas de água e luz, assim como de quaisquer outros tributos e taxas incidentes sobre o imóvel.\n9.2 No ato da devolução do imóvel, o LOCATÁRIO(a) se compromete a apresentar os comprovantes de pagamento de todas as taxas e tributos durante o período de locação, garantindo que não há débitos pendentes relacionados ao imóvel.',
  'CLÁUSULA DÉCIMA - DOS SINISTROS\n10.1 No caso de sinistro do prédio, parcial ou total, que impossibilite a habitação do imóvel locado, o presente contrato estará rescindido, independentemente de aviso ou interpelação judicial ou extrajudicial.\n10.2 No caso de incêndio parcial, obrigando obras de reconstrução, o presente contrato terá suspensa a sua vigência, sendo devolvido ao LOCATÁRIO após a reconstrução, que ficará prorrogado pelo mesmo tempo de duração das obras de reconstrução.',
  'CLÁUSULA DÉCIMA PRIMEIRA - DA SUBLOCAÇÃO\n11.1 É VEDADO ao LOCATÁRIO sublocar, transferir ou ceder o imóvel, sendo nulo de pleno direito qualquer ato praticado com este fim sem o consentimento prévio e por escrito do LOCADOR.',
  'CLÁUSULA DÉCIMA SEGUNDA - DA DESAPROPRIAÇÃO\n12.1 Em caso de desapropriação total ou parcial do imóvel locado, ficará rescindido de pleno direito o presente contrato de locação, sendo passível de indenização as perdas e danos efetivamente demonstradas.',
  'CLÁUSULA DÉCIMA TERCEIRA - DOS CASOS DE FALECIMENTO\n13.1 Falecendo o LOCADOR, ficam os seus sucessores sub-rogados dos direitos do presente contrato, devendo o LOCATÁRIO seguir depositando o valor do aluguel em conta indicada pelo inventariante, após devidamente notificado.\n13.2 Falecendo o LOCATÁRIO, ficam os seus sucessores sub-rogados dos direitos do presente contrato, devendo decidir dentro de 30 dias da continuidade ou não da LOCAÇÃO. O locador deve ser notificado da morte do LOCATÁRIO e informado de quem será o novo sucessor.',
  'CLÁUSULA DÉCIMA QUARTA - DA ALIENAÇÃO DO IMÓVEL\n14.1 No caso de alienação do imóvel, o LOCATÁRIO terá direito de preferência, e se não utilizar-se dessa prerrogativa formalmente, o LOCADOR poderá dispor livremente do imóvel.',
  'CLÁUSULA DÉCIMA QUINTA - DAS VISTORIAS\n15.1 É facultado ao LOCADOR, mediante aviso prévio, vistoriar o imóvel, por si ou seus procuradores, sempre que achar conveniente, para a certeza do cumprimento das obrigações assumidas neste contrato.',
  'CLÁUSULA DÉCIMA SEXTA - DOS ANIMAIS DOMÉSTICOS\n16.1 É permitida a presença de animais domésticos no interior do imóvel, desde que o LOCATÁRIO(a) se responsabilize integralmente por qualquer dano ou prejuízo que os animais possam causar às dependências do imóvel, a terceiros ou a áreas comuns, caso aplicável.\n16.2 O LOCATÁRIO(a) deverá garantir que os animais domésticos não perturbem a paz e a tranquilidade dos vizinhos, observando sempre as regras de convivência do condomínio (se houver) e da vizinhança.\n16.3 No término do contrato ou na devolução do imóvel, o LOCATÁRIO(a) deverá entregar o imóvel em condições de limpeza e conservação adequadas, livres de quaisquer vestígios que possam comprometer a integridade ou a higiene do imóvel devido à presença dos animais domésticos.\n16.4 Fica a cargo do LOCATÁRIO(a) o cumprimento das normas de saúde e segurança aplicáveis à criação e manutenção de animais domésticos, incluindo a responsabilidade por vacinação, higiene e controle de zoonoses.',
  'CLÁUSULA DÉCIMA SÉTIMA - DA RESCISÃO DO CONTRATO\n17.1 Em caso de rescisão antecipada do contrato pelo LOCATÁRIO(a), será devida uma multa proporcional ao tempo restante do contrato, correspondente a 3 (três) meses de aluguel.\n17.2 O cálculo da multa será feito da seguinte forma:\n* Multa total estipulada: 3 x {MONTHLY_VALUE}\n* Tempo total do contrato: 6 meses\n* Tempo restante até o término do contrato: (quantidade de meses restantes)\nMulta proporcional = (Tempo restante / Tempo total do contrato) x Multa total\n17.3 O LOCADOR(a) poderá rescindir o contrato antecipadamente em caso de inadimplemento de quaisquer das cláusulas ora estabelecidas, mediante notificação por escrito ao LOCATÁRIO(a) com antecedência mínima de 30 (trinta) dias.\n17.4 O LOCATÁRIO(a) se compromete a pagar a multa de rescisão proporcional no prazo de 10 (dez) dias após a formalização da rescisão contratual, juntamente com a entrega das chaves e dos comprovantes de pagamento de todas as taxas e tributos durante o período de locação.',
  ...
  'CLÁUSULA DÉCIMA NONA - FORO\n19.1 Fica eleito o foro da Comarca de Alto Araguaia , Estado de Mato Grosso , para dirimir quaisquer questões oriundas deste contrato, com exclusão de qualquer outro, por mais privilegiado que seja.\n19.2 E por estarem assim justos e contratados, assinam o presente contrato em 2 (duas) vias de igual teor.'
];
  ...
  const generatePDF = (contract: Contract) => {
    ...
    clausesToUse.forEach((clause) => {
      ...
      let processedClause = clause
        ...
        .replaceAll('{PAINT_COST}', formatCurrency(contract.paintCost || 0))
        .replaceAll('{GUARANTEE_VALUE}', formatCurrency(contract.guaranteeValue || 0));
                ...
                {activeTab === 'dados' && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-4">
                      ...
                      <div className="space-y-1">
                        <label className="text-sm font-semibold text-slate-400">Valor Caução (R$)</label>
                        <input 
                          type="number" 
                          className="w-full p-3 bg-slate-800 border border-slate-700 text-slate-100 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none"
                          value={formData.guaranteeValue || 0}
                          onChange={(e) => setFormData({ ...formData, guaranteeValue: Number(e.target.value) })}
                        />
                      </div>
                      <div className="space-y-1">
                        <label className="text-sm font-semibold text-slate-400">Custo Pintura (R$)</label>
                        <input 
                          type="number" 
                          className="w-full p-3 bg-slate-800 border border-slate-700 text-slate-100 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none"
                          value={formData.paintCost || 0}
                          onChange={(e) => setFormData({ ...formData, paintCost: Number(e.target.value) })}
                        />
                      </div>
                      <div className="space-y-1">
                ...
                {activeTab === 'clausulas' && (
                  <div className="space-y-4">
                    ...
                    <p className="text-xs text-slate-500 italic">
                      Use placeholders: {'{ADDRESS}'}, {'{DESCRIPTION}'}, {'{START_DATE}'}, {'{END_DATE}'}, {'{MONTHLY_VALUE}'}, {'{ADJUSTMENT_INDEX}'}, {'{OWNER_CPF}'}, {'{OWNER_NAME}'}, {'{LATE_FEE}'}, {'{PAINT_COST}'}, {'{GUARANTEE_VALUE}'}
                    </p>
                    <div className="space-y-4">
